...
For now, what else might you want to consider?  From the marketers point of view, an efficient price is a price might be the maximum that customers are willing to pay.  Are we maximizing profit margin?  Because it is subject to price elasticity, we need to get at the body count aspect as well.  Then we maximizing total profit?  Price is part of the Marketing Mix Strategy.  So you want to know the optimization objectives as well as the research driven optimization point from a volume by price perspective.  These are your "backdrop" rather than your one and done answer. 
