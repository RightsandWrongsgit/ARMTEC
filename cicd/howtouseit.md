...
We are going to make sure our local machine is set up like [outlined in the first part of the documentation.](/cicd/prerequisites.md)  If you are a relative novice, you might first want to look at our [even more core basics](/book/Novice.md#setting-up-your-basic-system) to make sure you have those in place.
