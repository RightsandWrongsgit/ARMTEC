...
Since you want to be clear about which environment you are working in and what subdirectory the file you are looking at is located in on that computer, it pays to do a little something special to move beyond your standard ['Command Prompt'](https://www.techtarget.com/whatis/definition/command-prompt)](https://www.alphr.com/open-command-prompt-mac/).  
