...
<div class="video-container">
    <iframe style="position: relative;padding-bottom: 56.25%;padding-top: 35px;" src="http://www.libreoffice.org/" height="315" width="560" allowfullscreen="" frameborder="0">
    </iframe>
</div>

- [LibreOffice (Software)](<iframe src="http://www.libreoffice.org/" height="500" width="750" allowfullscreen="" frameborder="0"></iframe>)   
...
- [Nodes and Fields - Loading and saving nodes and different types of fields, multivalue field magic, link fields, entity reference fields, url fields, storing JSON data into text fields, paragraphs, great cheat sheets](https://selwynpolit.github.io/d9book/nodes_n_fields.html)
