...
<font color=Curious Blue>Run "lando start"</font><br>
...
<font color=Curious Blue>Do a "lando pull"; Making selection via the space bar...</font><br>

<font color=Curious Blue>Run "make development_project"</font><br>

<font color=Curious Blue>Run "make project_yours"</font><br>

<font color=Curious Blue>Run "lando composer update"</font><br>

<font color=Curious Blue>Run "lando rebuild"</font><br>
...
Open another window in your browser and go to GitHub. Click on your project in GitHub.  Where it says "branches", go pull down the list and at the bottom click on 'View all branches'.  You should see your 'main' branch listed and now a second branch called 'staged'.<br> 
